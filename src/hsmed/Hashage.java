...
public class Hashage {
    ...
    public static void main(String[] args) {
        ...
        String hashMedecin = hashMDP(mdpMedecin);
        String hashSecretaire = hashMDP(mdpSecretaire);
        ...
        System.out.println("Médecin (medecin123): " + verifierMDP(mdpMedecin, hashMedecin));
        System.out.println("Secrétaire (secretaire123): " + verifierMDP(mdpSecretaire, hashSecretaire));
    }
}