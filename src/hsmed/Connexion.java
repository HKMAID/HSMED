...
public class Connexion extends JFrame {
    ...
    private void initComponents() {
        ...
        JPanel medecinButton = creerBoutonTypeUtili("👨‍⚕️", "MÉDECIN", "Accès aux dossiers médicaux", "Medecin", 10001);
        medecinButton.setPreferredSize(new Dimension(200, 150));
        buttonsFlowPanel.add(medecinButton);
        
        JPanel secretaireButton = creerBoutonTypeUtili("👩‍💼", "SECRÉTAIRE", "Gestion administrative", "Secretaire", 20001);
    ...
    private JPanel creerBoutonTypeUtili(String emoji, String title, String desc, String type, int matricule) {
        ...
        buttonPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                afficherDialogue(type, matricule);
            }
    ...
    private void afficherDialogue(String type, int matricule) {
    ...
    try (PreparedStatement pstmtSelect = db.prepareStatement(sqlSelect);
        ...
        if (rs.next()) {
            ...
            boolean result = Hashage.verifierMDP(motDePasse, hashStocke);
